...
function BtnNeptune(props) {
  ...
  return (
    <div className="btn-container-above-tablet">
      <div
        className={`btn-tablet-container-n ${Overview ? "Show" : ""}`}
      ...
      <div
        className={`btn-tablet-container-n  ${Structure ? "" : "Show"}`}
      ...
      <div
        className={`btn-tablet-container-n  ${Surface ? "Show" : ""}`}
