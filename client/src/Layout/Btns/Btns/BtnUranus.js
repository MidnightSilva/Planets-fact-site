...
function BtnUranus(props) {
  ...
  return (
    <div className="btn-container-above-tablet">
      <div
        className={`btn-tablet-container-u ${Overview ? "Show" : ""}`}
      ...
      <div
        className={`btn-tablet-container-u  ${Structure ? "" : "Show"}`}
      ...
      <div
        className={`btn-tablet-container-u ${Surface ? "Show" : ""}`}
